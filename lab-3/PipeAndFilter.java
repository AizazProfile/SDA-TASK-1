...
public class PipeAndFilter {
    public static void main(String[] args) {
        ...
        filters.add(PipeAndFilter::multiplyByTwo);  // Added new filter
    ...
    // New filter: multiply each number by 2
    private static List<Integer> multiplyByTwo(List<Integer> input) {
        return input.stream()
                    .map(n -> n * 2)
                    .collect(Collectors.toList());
    }
